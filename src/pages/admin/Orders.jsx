...
const AdminOrders = () => {
  ...
  return (
    <div className="ns-orders-wrapper">
      ...
      <div className="ns-orders-header-row">
        ...
        <div className="ns-orders-actions">
          <div className="ns-orders-search-box">
            <svg
              className="ns-orders-search-icon"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
      ...
      {error && <div className="ns-orders-error-alert">{error}</div>}
      ...
      <div className="ns-orders-content-card">
        {visibleOrders.length === 0 ? (
          <div className="ns-orders-empty-state">
            ...
            <p>
              You have processed all your orders or the search didn't match
              anything.
            </p>
          </div>
        ) : (
              ...
              <tbody>
                {visibleOrders.map((order) => (
                  <tr key={order._id}>
                    {/* Order Details */}
                    <td>
                      <div className="ns-orders-id">
                        #{order._id.substring(18, 24).toUpperCase()}
                      </div>
                      <div className="ns-orders-date">
                    ...
                    {/* Customer Info */}
                    <td>
                      <div className="ns-orders-customer-name">
                        {order.user?.name || "Unknown User"}
                      </div>
                      <div className="ns-orders-customer-email">
                    ...
                    <td>
                      <span
                        className={`ns-orders-badge ${order.isPaid ? "badge-success" : "badge-error"}`}
                      >
                    ...
                    <td>
                      <span
                        className={`ns-orders-badge badge-${order.orderStatus.replace(/\s+/g, "-").toLowerCase()}`}
                      >
                        {order.orderStatus}
                      </span>
                    </td>
                    ...
                    {/* Action Dropdown */}
                    <td>
                      <div className="ns-orders-action-group">
                        <button
  className="ns-orders-view-btn"
