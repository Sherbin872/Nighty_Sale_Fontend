    ...
    <div className="checkout-steps">
      {steps.map((step, index) => (
        <div key={step} className="step-container">
          ...
          <span
            className={`step-label ${index === currentStep ? "current" : ""}`}
          >
            {step}
          </span>
...
// Calculate order summary using the service
  ...
  // NEW: Calculate physical quantity to display the correct free shipping message
  ...
  const handleShippingSubmit = (e) => {
    ...
    if (!stockCheck.available) {
      toast.error(
        `Sorry, the following items are out of stock: ${stockCheck.items.join(", ")}`,
      );
      return;
    }
  ...
  const handlePaymentSubmit = async () => {
    try {
      ...
      const preparedCartItems = cartItems.map((item) => ({
        ...
        image:
          typeof item.image === "object" ? item.image.thumbnail : item.image,
                ...
                <div className="payment-method-info">
                  ...
                  <div className="secure-payment-info">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M12 15.5C9.79 15.5 8 16.29 8 17.5V18.5H16V17.5C16 16.29 14.21 15.5 12 15.5Z"
                        fill="white"
                      />
                    </svg>
            ...
            <div className="order-summary">
              ...
              <div className="cart-items-summary">
                {cartItems.map((item, index) => {
                  ...
                  return (
                    <div
                      key={`${item.product || item.productId}-${item.size}-${index}`}
              ...
              <div className="order-totals">
                ...
                {/* Updated Free Shipping Notice */}
                {totalPhysicalItems < 3 && orderTotals.shippingPrice > 0 && (
                  <div className="free-shipping-notice">
                    ...
                    <span>
                      Add {3 - totalPhysicalItems} more{" "}
                      {3 - totalPhysicalItems === 1 ? "item" : "items"} for FREE
                      shipping!
                    </span>
                  </div>
                )}
                ...
                if (!stockCheck.available) {
                  return (
                    <div className="stock-warning">
                      ...
                      >
                        <path
                          d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-2.694-.833-3.464 0L4.332 16.5c-.77.833.192 2.5 1.732 2.5z"
                          stroke="#f44336"
                          strokeWidth="2"
                        />
                      </svg>
